...
class BlogForm(forms.Form):
    ...
    category = MyMultipleModelChoiceField(label='Tags', widget=forms.CheckboxSelectMultiple, queryset=Category.objects.all(), help_text="If your desired tag is not defined then create tag first")
